...
def query(file_path,commit_id):
    for AI_reviewer in actions:
        ...
        source_fname = f"{crawling_directory}/reviewed_file_versions.parquet"
...
if __name__ == "__main__":
    file_path = "consensus/state_sync/server.go"
    commit_id = "82d931822979d5286c0cd811cf3f7f31ebb5897b"
